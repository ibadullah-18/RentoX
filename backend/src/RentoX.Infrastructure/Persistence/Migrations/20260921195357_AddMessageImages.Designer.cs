...
namespace RentoX.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260921195357_AddMessageImages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentoX.Domain.Listings.Billing.ListingBillingCycle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RefundWalletTransactionId")
                        .IsUnique();

                    b.HasIndex("WalletTransactionId")
                        .IsUnique();

                    b.HasIndex("ListingId", "CycleNumber")
                        .IsUnique();

                    b.HasIndex("ListingId", "PeriodEndUtc");

                    b.ToTable("listing_billing_cycles", "payments");
                });
            ...
            modelBuilder.Entity("RentoX.Domain.Messaging.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RentoX.Domain.Messaging.MessageImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MessageId", "DisplayOrder")
                        .IsUnique();

                    b.ToTable("message_images", "messaging", t =>
                        {
                            t.HasCheckConstraint("CK_message_images_DisplayOrder", "\"DisplayOrder\" >= 0 AND \"DisplayOrder\" < 5");
            ...
            modelBuilder.Entity("RentoX.Domain.Stores.StoreFollower", b =>
                {
                    ...
                    b.ToTable("store_followers", "engagement");
                });
            ...
            modelBuilder.Entity("RentoX.Domain.Wallets.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RentoX.Domain.Listings.Billing.ListingBillingCycle", b =>
                {
                    ...
                    b.HasOne("RentoX.Domain.Wallets.WalletTransaction", null)
                        .WithMany()
                        .HasForeignKey("RefundWalletTransactionId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("RentoX.Domain.Stores.StoreFollower", b =>
                {
                    b.HasOne("RentoX.Domain.Stores.StoreProfile", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RentoX.Domain.Wallets.Wallet", b =>
                {
                    b.HasOne("RentoX.Infrastructure.Identity.AppUser", null)
                        .WithOne()
                        .HasForeignKey("RentoX.Domain.Wallets.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("RentoX.Domain.Wallets.WalletTransaction", b =>
                {
                    b.HasOne("RentoX.Domain.Wallets.Wallet", null)
